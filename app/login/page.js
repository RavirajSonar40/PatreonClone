...
const Login = () => {
    ...
    if (status === "authenticated") {
        return null;  // You can return a loader or null while redirecting
    }

    return (
        <>
            <div className="flex flex-col gap-2 py-32 justify-center  items-center text-white p-10 overflow-x-hidden">
                <button onClick={()=>{signIn("google")}}
                    className="flex items-center w-72 gap-5  border border-black-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
